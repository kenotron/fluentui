 ...
 */
export declare function safeCreate<TProps>(content: React.ReactElement<TProps>, callback: (wrapper: renderer.ReactTestRenderer) => void, options?: renderer.TestRendererOptions): void;
