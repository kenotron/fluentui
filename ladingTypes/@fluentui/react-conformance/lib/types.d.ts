...
export declare type Tests = keyof typeof defaultTests;
/**
...
export declare type ConformanceTest<TProps = {}> = (componentInfo: ComponentDoc, testInfo: IsConformantOptions<TProps>) => void;
