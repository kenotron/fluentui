...
export declare type FlexItemSlotProps = SlotProps<FlexItemSlots, FlexItemProps, React.HTMLAttributes<HTMLElement>>;
export declare type FlexItemTokens = ColorTokenSet & {
    /**
