 ...
 * {@docCategory Checkbox}
 */
export declare type ICheckboxClasses = {
    [key in keyof ICheckboxSlots]: string;
};
/**
 * {@docCategory Checkbox}
 */
export declare type ICheckboxSlotProps = SlotProps<ICheckboxSlots, ICheckboxProps, React.HTMLAttributes<HTMLDivElement>>;
