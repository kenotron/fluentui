 ...
 */
export declare const avatarSizeValues: readonly [20, 24, 28, 32, 36, 40, 48, 56, 64, 72, 96, 120, 128];
export declare type AvatarSizeValue = typeof avatarSizeValues[number];
/** Default Avatar size if not specified */
export declare const defaultAvatarSize: AvatarSizeValue;
/**
 * Style tokens for the Avatar
 */
export declare type AvatarTokenSet = {
    /** Width of the avatar */
    width?: string;
...
export declare type AvatarState = AvatarProps;
